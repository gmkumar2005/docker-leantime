...
class config
{
    ...
    /* Database */
    public $dbHost=getenv('MYSQL_HOST'); //Database host
	public $dbUser=getenv('MYSQL_USER'); //Database username
	public $dbPassword=getenv('MYSQL_PASSWORD'); //Database password
	public $dbDatabase=getenv('MYSQL_DATABASE'); //Database name
